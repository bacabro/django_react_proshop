...
export const login = (email, password) => async (dispatch) => {
    ...
    try {
        ...
        // await axios.post('/api/users/login', {'username': email, 'password': password}, config)
        // .then(response =>{
...
export const getUserDetails = (id) => async(dispatch, getState) => {
    try {
        ...
        //     `api/users/${id}/`, 
        //     config) for some reason is not working
        ...
        //console.log('Data response do be dispatched ' , data)
